...
board_word={'八卦' : 'Gossiping', '綜合' : 'WorldCup', '股票' : 'Stock',
            '希洽' : 'C_Chat', 'NBA' : 'NBA', '省錢' : 'Lifeismoney',
            '棒球' : 'Baseball', '政黑' : 'HatePolitics', '房屋' : 'home-sale',
            '運彩' : 'SportLottery', '汽車' : 'car', '表特' : 'Beauty',
            '電蝦' : 'PC_Shopping', '電影' : 'movie', '西斯' : 'sex',
            '寶媽' : 'BabyMother', '台藍' : 'basketballTW', '科技' : 'Tech_Job',
            '軍事' : 'Military', '韓星' : 'KoreaStar', '日本旅遊' : 'Japan_Travel',
            '女孩聊天' : 'WomenTalk', '通訊' : 'MobileComm', 'LoL' : 'LoL',
            '男女' : 'Boy-Girl', '歐兔' : 'AllTogether', 'PM' : 'PokeMon',
            'ios' : 'iOS', 'AV女優版' : 'japanavgirls', 'PS5' : 'PlayStation',
            'steam' : 'Steam', '台南' : 'Tainan', '高雄' : 'Kaohsiung',
            'NS' : 'NSwitch', '日劇' : 'Japandrama', '就可' : 'joke',
            '網購' : 'e-shopping', '卡版' : 'creditcard', '台中' : 'TaichungBun',
            '媽佛' : 'marvel', 'PoE' : 'PathofExile', '玄幻' : 'CFantasy',
            '硬交' : 'HardwareSale', '邊緣' : 'Marginalman', '期權' : 'Option',
            'WOW' : 'WOW', '數位貨幣' : 'DigiCurrency', '資訊' : 'CVS', '閒談' : 'AC_In',
